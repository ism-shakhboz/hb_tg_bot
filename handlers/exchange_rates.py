...
@dp.message_handler(lambda message: get_user_state(message.from_user.id) == get_state_by_key('S_EXCHANGE_RATES'))
...
@dp.message_handler(lambda message: get_user_state(message.from_user.id) == get_state_by_key('S_CALCULATOR'))
...
@dp.message_handler(lambda message: get_user_state(message.from_user.id) == get_state_by_key('S_PURCHASE_CURRENCY'))
...
@dp.message_handler(lambda message: get_user_state(message.from_user.id) == get_state_by_key('S_SALE_CURRENCY'))
